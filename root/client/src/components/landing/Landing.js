...
function Landing() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center w-full gap-5 customGradient">
      <div className="flex flex-col justify-center items-center w-full md:w-[50%] h-screen text-white gap-4 p-5 text-center">
      ...
      <div className="flex flex-col justify-center items-center w-full md:w-[50%] h-screen">
        <AuthPanel />
      </div>
    </div>
  );
